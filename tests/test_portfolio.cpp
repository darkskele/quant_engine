...
TEST(PortfolioTest, OpensLongCorrectly)
{
    ...
    pf.on_fill(fill_event{"BTCUSD", 10, true, 100.0}); // buy 10 @ 100
...
TEST(PortfolioTest, AddsToLongAveragesPrice)
{
    ...
    pf.on_fill(fill_event{"BTCUSD", 10, true, 100.0});
    pf.on_fill(fill_event{"BTCUSD", 10, true, 120.0}); // avg to 110
...
TEST(PortfolioTest, ReducesLongRealizesPnL)
{
    ...
    pf.on_fill(fill_event{"BTCUSD", 20, true, 100.0}); // long 20 @ 100
    pf.on_fill(fill_event{"BTCUSD", 5, false, 130.0}); // sell 5 @ 130
...
TEST(PortfolioTest, ClosesLongResetsPosition)
{
    ...
    pf.on_fill(fill_event{"BTCUSD", 20, true, 100.0});
    pf.on_fill(fill_event{"BTCUSD", 20, false, 90.0}); // sell all
...
TEST(PortfolioTest, FlipsLongToShort)
{
    portfolio_manager pf(2000.0);
    pf.on_fill(fill_event{"BTCUSD", 10, true, 100.0});
    pf.on_fill(fill_event{"BTCUSD", 15, false, 110.0}); // sell 15
...
{
    portfolio_manager pf(2000.0);
    pf.on_fill(fill_event{"BTCUSD", 10, false, 200.0}); // short 10 @ 200
...
TEST(PortfolioTest, CoversShortPartially)
{
    ...
    pf.on_fill(fill_event{"BTCUSD", 10, false, 200.0}); // short 10
    pf.on_fill(fill_event{"BTCUSD", 5, true, 180.0});   // buy 5
...
TEST(PortfolioTest, FlipsShortToLong)
{
    portfolio_manager pf(4000.0);
    pf.on_fill(fill_event{"BTCUSD", 10, false, 200.0}); // short 10
    pf.on_fill(fill_event{"BTCUSD", 15, true, 210.0});  // buy 15
...
TEST(PortfolioTest, AppliesSlippageAndCommission)
{
    ...
    pf.on_fill(fill_event{"BTCUSD", 1, true, 100.0}); // buy 1
...
{
    portfolio_manager pf(1000.0);
    pf.on_fill(fill_event{"BTCUSD", 1, true, 100.0});
    pf.on_fill(fill_event{"BTCUSD", 1, false, 120.0});
